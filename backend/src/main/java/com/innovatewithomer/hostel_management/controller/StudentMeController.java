...
public class StudentMeController {
    ...
    public StudentProfileResponse getStudentProfile() {
        ...
        Student student = studentRepository.findByUserEmail(email)
                .orElseThrow(() -> new RuntimeException("You have not been admitted yet kindly contact admin for your admission"));

        StudentRequest studentRequest = new StudentRequest();
        studentRequest.setCnic(student.getCnic());
        ...
        response.setHostel(student.getHostel());
    ...
    public StudentRoomResponse getMyRoom() {
        ...
        Allocation alloc = allocationRepository.findByStudent_IdAndActiveTrue(student.getId())
        ...
        response.setHostel(alloc.getStudent().getHostel());
