// HomePage.jsx - Hostel Concept (No Pricing, Mess Facility Added)
...
export default function HomePage() {
  ...
  const features = [
    ...
    {
      icon: BeakerIcon,  // representing mess/dining
      title: "Mess Facility",
    ...
    <div className="bg-white font-sans overflow-hidden">
      ...
      <section id="home" className="relative min-h-screen flex items-center hero-offset">
        ...
        <div className="container relative mx-auto px-4">
          ...
          {/* Hero Room Preview - REMOVED (no pricing) */}
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
                ...
                {/* Removed "Learn more about our story" link */}
              </div>
            </div>
          </div>
        </div>
              ...
              {rooms.map((room, index) => (
                ...
                >
                  ...
                  <div className="relative h-64 overflow-hidden">
                    ...
                    {room.featured && (
                      <div className="absolute top-4 left-4">
                        {/* Removed "MOST POPULAR" badge (optional keep) */}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    {/* Inquire button instead of Book Now */}
                    <button
                ...
                <div className="space-y-8">
                  {[
                    ...
                    },
                    {
                      icon: EnvelopeIcon,
                      title: "Email Us",
                      details: ["info@officershostel.com", "skq547@gmail.com"],
                    }
                  ].map((item, index) => (
                    <div
                      key={index}
